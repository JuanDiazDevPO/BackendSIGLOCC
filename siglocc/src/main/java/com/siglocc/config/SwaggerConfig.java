 ...
 *
 * <p>Hace dos cosas principales:</p>
 * <ol>
 ...
 *       para probar los endpoints protegidos sin necesidad de un cliente externo.</li>
 *   <li><strong>Personaliza la información de la API:</strong> Título, descripción
 *       y versión que aparecen en la cabecera de Swagger UI.</li>
 * </ol>
 *
 * <p>Los endpoints de Swagger están permitidos sin autenticación en
 * {@link SecurityConfig} ({@code /swagger-ui/**, /v3/api-docs/**}).</p>
 *
 * <p>Acceso: {@code http://localhost:8080/swagger-ui/index.html}</p>
 */
@Configuration
@SecurityScheme(
        name = "bearerAuth",
